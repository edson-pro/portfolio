...
<div class="max-w-3xl py-10 mx-auto px-3">
  <div>
    ...
    >
      <p class="mb-2">
        Hi There! 👋, I' am <a
          class="bg-slate-200 dark:bg-slate-800 px-3 py-1 rounded-[3px]"
          href="#">Edson Ntwali</a
        >. a passionate software engineer based in
        <a
          class="bg-slate-200 dark:bg-slate-800 px-3 py-1 rounded-[3px]"
          target="_blank"
          href="https://www.visitrwanda.com/">Rwanda</a
        > focused in innovating special software to solve a problem while i work.
      </p>
      <p>
        I am experienced in developing Websites & Mobile applications and the
        Backend using some of the popular tech stack out there.
      </p>
    </div>
    <a
    ...
    <div class="flex items-center my-8 gap-8">
      <a
        ...
        ><svg
          ...
          width="16"
          height="16"
          class="text-slate-600 dark:text-slate-400 fill-current"
          viewBox="0 0 24 24"
          ><path
