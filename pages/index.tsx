...
const Home: NextPage = () => {
  return (
    <div>
      <div className="max-w-4xl my-10 gap-8 mx-auto px-3 grid grid-cols-6">
        <div className="col-span-2">
          <img
            className="rounded-[4px] "
            src="https://avatars.githubusercontent.com/u/78101497?v=4"
            alt="Ntwali edson - software developer"
          />
          <div className="flex mt-6 flex-col justify-center items-center">
            <h4 className="font-extrabold text-[15px] mb-2 capitalize">
              Ntwali edson
            </h4>
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            {[
              ...
              },
              {
                ...
                subtitle: "ntwaliedson9@gmail.com",
              },
              {
                color: "#6ab5b9",
                title: "location",
              ...
              return (
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <h4 className="text-sm capitalize font-bold">{e.title}</h4>
                    <span className="text-sm capitalize font-semibold text-gray-500">
                      {e.subtitle}
                    </span>
                  </div>
                </div>
